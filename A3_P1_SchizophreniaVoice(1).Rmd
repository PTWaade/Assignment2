...
#Read files
d1 = read.table("pitch/Study1D0S101T1_f0.txt", header = T)
...
iqr1 = IQR(d1$f0)
mad1 = mean(abs(d1$fo-mean(d1$f0)))
cov1 = sd(d1$f0) / mean(d1$f0)

#Extract complex descriptors
crqa1=crqa (d1, d1, delay=1, embed=1, radius=1,normalize=0,rescale=0,mindiagline = 2,minvertline = 2) 
